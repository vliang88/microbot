<<<<<<<< HEAD:runelite-client/src/main/java/net/runelite/client/plugins/microbot/DDAdvertiser/DDAdvertiserOverlay.java
...
public class DDAdvertiserOverlay extends OverlayPanel {
    @Inject
    DDAdvertiserOverlay(DDAdvertiserPlugin plugin)
    {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                    .text("DDAdvertiserScript" + DDAdvertiserScript.version)
                    .color(Color.GREEN)
                    .build());
...
>>>>>>>> main:runelite-client/src/main/java/net/runelite/client/plugins/microbot/CrashedStar/CrashedStarOverlay.java
