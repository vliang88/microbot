...
public enum BlastFurnanceBars {
    ...
    Steel("Steel Bar","Iron", "Coal", 30, 1, Varbits.BLAST_FURNACE_STEEL_BAR, ItemID.STEEL_BAR, ItemID.IRON_ORE, ItemID.COAL),
    Gold("Gold Bar", "Gold", "None",30, 0, Varbits.BLAST_FURNACE_GOLD_BAR, ItemID.GOLD_BAR, ItemID.GOLD_ORE, 0),
    Mithril("Mithril Bar", "Mithril", "Coal",50, 2, Varbits.BLAST_FURNACE_MITHRIL_BAR,ItemID.MITHRIL_BAR, ItemID.MITHRIL_ORE, ItemID.COAL),
    Adamantite("Adamantite Bar", "Adamantite", "Coal",70, 3, Varbits.BLAST_FURNACE_ADAMANTITE_BAR, ItemID.ADAMANTITE_BAR, ItemID.ADAMANTITE_ORE, ItemID.COAL),
    Rune("Rune Bar", "Runite", "Coal",85, 4, Varbits.BLAST_FURNACE_RUNITE_BAR, ItemID.RUNITE_BAR, ItemID.RUNITE_ORE, ItemID.COAL);
